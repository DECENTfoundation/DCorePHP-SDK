...
class OperationFactory
{
    ...
    {
        return [
            Operation\TransferOperation::OPERATION_TYPE => Operation\TransferOperation::class,
            Operation\AccountCreateOperation::OPERATION_TYPE => Operation\AccountCreateOperation::class,
            Operation\AccountUpdateOperation::OPERATION_TYPE => Operation\AccountUpdateOperation::class,
            ...
            19 => 'assert',
            Operation\AddOrUpdateContentOperation::OPERATION_TYPE => Operation\AddOrUpdateContentOperation::class,
            Operation\PurchaseContentOperation::OPERATION_TYPE => Operation\PurchaseContentOperation::class,
            ...
            Operation\RemoveContentOperation::OPERATION_TYPE => Operation\RemoveContentOperation::class,
