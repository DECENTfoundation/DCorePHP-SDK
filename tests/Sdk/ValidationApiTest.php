        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->will($this->onConsecutiveCalls(
                    ...
                    GetRequiredSignatures::responseToModel(new BaseResponse('{"id":9,"result":["DCT6TjLhr8uESvgtxrbWuXNAN3vcqzBMw5eyEup3PMiD2gnVxeuTb"]}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->will($this->onConsecutiveCalls(
                    ...
                    GetRequiredFees::responseToModel(new BaseResponse('{"id":7,"result":[{"amount":100000,"asset_id":"1.3.0"}]}')),
                    Database::responseToModel(new BaseResponse('{"id":8,"result":6}')),
                    VerifyAuthority::responseToModel(new BaseResponse('{"id":9,"result":false}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[1,"login",["",""]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[1,"database",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[6,"verify_account_authority",["public-account-10",["DCT5PwcSiigfTPTwubadt85enxMFC18TtVoti3gnTbG7TN9f9R3Fp"]]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Login::responseToModel(new BaseResponse('{"id":1,"result":true}')),
                    Database::responseToModel(new BaseResponse('{"id":2,"result":6}')),
                    VerifyAccountAuthority::responseToModel(new BaseResponse('{"id":3,"result":true}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[1,"login",["",""]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[1,"database",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[6,"get_required_fees",[[[39,{"from":"1.2.27","to":"1.2.28","amount":{"amount":10,"asset_id":"1.3.0"},"fee":{"amount":0,"asset_id":"1.3.0"},"memo":{"message":null,"nonce":"'.$req->getParams()[0][0][1]['memo']['nonce'].'"}}]],"1.3.0"]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Login::responseToModel(new BaseResponse('{"id":1,"result":true}')),
                    Database::responseToModel(new BaseResponse('{"id":2,"result":6}')),
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[1,"login",["",""]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[1,"database",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[6,"get_required_fees",[[[]],"1.3.0"]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Login::responseToModel(new BaseResponse('{"id":1,"result":true}')),
                    Database::responseToModel(new BaseResponse('{"id":2,"result":6}')),
