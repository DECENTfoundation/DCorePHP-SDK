    ...
    public function testGetInfo(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"info",[]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Info::responseToModel(new BaseResponse('{"id":1,"result":"database_api"}'))
                ));
        }
    ...
    public function testGetChainProps(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_chain_properties",[]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    GetChainProperties::responseToModel(new BaseResponse('{"id":1,"result":{"id":"2.9.0","chain_id":"a76a2db75f7a8018d41f2d648c766fdb0ddc79ac77104d243074ebdd5186bfbe","immutable_parameters":{"min_miner_count":11,"num_special_accounts":0,"num_special_assets":0}}}'))
                ));
        }
    ...
    public function testChainId(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_chain_id",[]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
    ...
    public function testTimeToMaintenance(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_time_to_maint_by_block_time",["2018-10-13T22:26:02.825"]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    GetTimeToMaintenance::responseToModel(new BaseResponse('{"id":1,"result":{"time_to_maint":5638,"from_accumulated_fees":1254865054,"block_interval":5}}'))
                ));
        }
