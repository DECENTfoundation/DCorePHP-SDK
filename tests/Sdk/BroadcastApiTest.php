        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    ...
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[0,"get_required_fees",[[[39,{"from":"1.2.27","to":"1.2.28","amount":{"amount":'. $req->getParams()[0][0][1]['amount']['amount'] .',"asset_id":"1.3.0"},"fee":{"amount":0,"asset_id":"1.3.0"},"memo":{"message":"0000000041686f7920504850","nonce":"0"}}]],"1.3.0"]]}'; })],
                ...
                ->will($this->onConsecutiveCalls(
                    ...
                    BroadcastTransaction::responseToModel(new BaseResponse('{"id":4,"result":null}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_dynamic_global_properties",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[0,"get_chain_id",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[0,"get_required_fees",[[[39,{"from":"1.2.28","to":"1.2.27","amount":{"amount":'. $req->getParams()[0][0][1]['amount']['amount'] .',"asset_id":"1.3.0"},"fee":{"amount":0,"asset_id":"1.3.0"},"memo":{"message":"0000000041686f7920504850","nonce":"0"}}]],"1.3.0"]]}'; })],
