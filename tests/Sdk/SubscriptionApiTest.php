        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->will($this->onConsecutiveCalls(
                    ...
                    GetSubscription::responseToModel(new BaseResponse('{"id":3,"result":{"id":"2.15.0","from":"1.2.83","to":"1.2.82","expiration":"2019-05-12T07:26:40","automatic_renewal":false}}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[1,"login",["",""]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[1,"database",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[6,"list_subscriptions_by_consumer",["1.2.83",100]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Login::responseToModel(new BaseResponse('{"id":1,"result":true}')),
                    Database::responseToModel(new BaseResponse('{"id":2,"result":6}')),
                    ListSubscriptionsByConsumer::responseToModel(new BaseResponse('{"id":3,"result":[{"id":"2.15.0","from":"1.2.83","to":"1.2.82","expiration":"2019-05-12T07:26:40","automatic_renewal":false}]}'))
                ));
        }
        ...
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[1,"login",["",""]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[1,"database",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[6,"list_subscriptions_by_author",["1.2.82",100]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    Login::responseToModel(new BaseResponse('{"id":1,"result":true}')),
                    Database::responseToModel(new BaseResponse('{"id":2,"result":6}')),
                    ListSubscriptionsByAuthor::responseToModel(new BaseResponse('{"id":3,"result":[{"id":"2.15.0","from":"1.2.83","to":"1.2.82","expiration":"2019-05-12T07:26:40","automatic_renewal":false}]}'))
                ));
        }
