    ...
    public function testGetAssetPerBlock(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_asset_per_block_by_block_num",["100"]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
    ...
    public function testGetMinerByAccount(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_miner_by_account",["1.2.4"]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    GetMinerByAccount::responseToModel(new BaseResponse('{"id":1,"result":{"id":"1.4.1","miner_account":"1.2.4","last_aslot":10489730,"signing_key":"DCT5j2bMj7XVWLxUW7AXeMiYPambYFZfCcMroXDvbCfX1VoswcZG4","pay_vb":"1.9.6","vote_id":"0:0","total_votes":"509480350335","url":"","total_missed":479000,"last_confirmed_block_num":4433245,"vote_ranking":7}}'))
                ));
        }
    ...
    public function testGetMinerCount(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_miner_count",[]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
    ...
    public function testGetMiners(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"lookup_miner_accounts",["",2]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[0,"get_objects",[["1.4.13","1.4.14"]]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    LookupMinerAccounts::responseToModel(new BaseResponse('{"id":1,"result":[["all-txs","1.4.13"],["dont-vote-for-me","1.4.14"]]}')),
                    GetMiners::responseToModel(new BaseResponse('{"id":2,"result":[{"id":"1.4.13","miner_account":"1.2.85","last_aslot":0,"signing_key":"DCT6ZNZ5KGadKr346doCUvUUYu1fTgDoTwEV1aCbrNqgP82oN9ADt","vote_id":"0:12","total_votes":"5116212431583078","url":"my new URL","total_missed":399756,"last_confirmed_block_num":0,"vote_ranking":0},{"id":"1.4.14","miner_account":"1.2.12649","last_aslot":0,"signing_key":"DCT77jKjNhFD9UVf6b9qUazzf2VizxuwSNbmRB8dZbB5V4kcNm229","vote_id":"0:13","total_votes":0,"url":"","total_missed":0,"last_confirmed_block_num":0,"vote_ranking":13}]}'))
                ));
        }
    ...
    public function testGetNewAssetPerBlock(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_new_asset_per_block",[]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
    ...
    public function testFindVotedMiners(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"lookup_vote_ids",[["0:0","0:1"]]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    LookupVoteIds::responseToModel(new BaseResponse('{"id":1,"result":[{"id":"1.4.1","miner_account":"1.2.4","last_aslot":10573977,"signing_key":"DCT51ojM7TUGVpFNUJWX8wi5dYp4iA4brRG16zWfcteVZRZHnkWCF","pay_vb":"1.9.6","vote_id":"0:0","total_votes":"509468350330","url":"","total_missed":479000,"last_confirmed_block_num":4502399,"vote_ranking":7},{"id":"1.4.2","miner_account":"1.2.5","last_aslot":10573974,"signing_key":"DCT5j2bMj7XVWLxUW7AXeMiYPambYFZfCcMroXDvbCfX1VoswcZG4","pay_vb":"1.9.4","vote_id":"0:1","total_votes":"508736301440","url":"","total_missed":479002,"last_confirmed_block_num":4502397,"vote_ranking":8}]}'))
                ));
        }
    ...
    public function testFindAllVotingInfo(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"search_miner_voting",["public-account-9","init",true,"-name",null,1000]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
    ...
    public function testCreateVoteOperation(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->method('send')
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_objects",[["1.4.4"]]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[0,"get_objects",[["1.4.4"]]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[0,"get_accounts",[["1.2.27"]]]}'; })]
                )
                ->will($this->onConsecutiveCalls(
                    GetMiners::responseToModel(new BaseResponse('{"id":1,"result":[{"id":"1.4.4","miner_account":"1.2.7","last_aslot":1067703,"signing_key":"DCT51ojM7TUGVpFNUJWX8wi5dYp4iA4brRG16zWfcteVZRZHnkWCF","pay_vb":"1.9.4","vote_id":"0:3","total_votes":"1999034598065","url":"","total_missed":36110,"last_confirmed_block_num":670484,"vote_ranking":0}]}')),
                    GetMiners::responseToModel(new BaseResponse('{"id":2,"result":[{"id":"1.4.4","miner_account":"1.2.7","last_aslot":1067703,"signing_key":"DCT51ojM7TUGVpFNUJWX8wi5dYp4iA4brRG16zWfcteVZRZHnkWCF","pay_vb":"1.9.4","vote_id":"0:3","total_votes":"1999034598065","url":"","total_missed":36110,"last_confirmed_block_num":670484,"vote_ranking":0}]}')),
    ...
    public function testVote(): void
    {
        if ($this->websocketMock) {
            $this->websocketMock
                ...
                ->withConsecutive(
                    [$this->callback(function(BaseRequest $req) { return $req->setId(1)->toJson() === '{"jsonrpc":"2.0","id":1,"method":"call","params":[0,"get_objects",[["1.4.4"]]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(2)->toJson() === '{"jsonrpc":"2.0","id":2,"method":"call","params":[0,"get_accounts",[["1.2.27"]]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(3)->toJson() === '{"jsonrpc":"2.0","id":3,"method":"call","params":[0,"get_dynamic_global_properties",[]]}'; })],
                    [$this->callback(function(BaseRequest $req) { return $req->setId(4)->toJson() === '{"jsonrpc":"2.0","id":4,"method":"call","params":[0,"get_chain_id",[]]}'; })],
